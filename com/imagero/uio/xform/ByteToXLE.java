...
public class ByteToXLE {
	...
	public static final int byteToInt(byte[] source, int sourceOffset, int[] dest, int destOffset) {
		int v = ((source[sourceOffset++] & 0xFF)) | (((source[sourceOffset++] & 0xFF)) << 8)
				| (((source[sourceOffset++] & 0xFF)) << 16) | (((source[sourceOffset++] & 0xFF)) << 24);
		dest[destOffset] = v;
		return sourceOffset;
	}
	...
	public static int byteToDoubleLE(byte[] source, int sourceOffset, double[] dest, int destOffset) {
		long v = (source[sourceOffset++] & 0xFF) | ((long) (source[sourceOffset++] & 0xFF) << 8)
				| ((long) (source[sourceOffset++] & 0xFF) << 16) | ((long) (source[sourceOffset++] & 0xFF) << 24)
				| ((long) (source[sourceOffset++] & 0xFF) << 32) | ((long) (source[sourceOffset++] & 0xFF) << 40)
				| ((long) (source[sourceOffset++] & 0xFF) << 48) | ((long) (source[sourceOffset++] & 0xFF) << 56);
	...
	public static long byteToLongLE(byte[] source, int sourceOffset) {
		return (source[sourceOffset++] & 0xFF) | ((long) (source[sourceOffset++] & 0xFF) << 8)
				| ((long) (source[sourceOffset++] & 0xFF) << 16) | ((long) (source[sourceOffset++] & 0xFF) << 24)
				| ((long) (source[sourceOffset++] & 0xFF) << 32) | ((long) (source[sourceOffset++] & 0xFF) << 40)
				| ((long) (source[sourceOffset++] & 0xFF) << 48) | ((long) (source[sourceOffset++] & 0xFF) << 56);
	}
	...
	public static final void byteToIntLE(final int bytesInInt, byte[] source, int sourceOffset, final int count,
	...
	public static final void byteToShortLE(final int bytesInShort, byte[] source, int sourceOffset, final int count,
	...
	public static final void byteToLongLE(final int bytesInLong, byte[] source, int sourceOffset, final int count,
			long[] dest, int destOffset) {
		for (int i = 0; i < count; i++) {
			long v = 0;
	...
	public static final int byteToShortLE(int bytesInShort, byte[] source, int sourceOffset, short[] dest,
			int destOffset) {
		int v = 0;
	...
	public static final int byteToLongLE(int bytesInLong, byte[] source, int sourceOffset, long[] dest,
			int destOffset) {
		long v = 0;
