...
public class ByteToXLE {
	...
	int v = ((source[sourceOffset++] & 0xFF)) | (((source[sourceOffset++] & 0xFF)) << 8) | (((source[sourceOffset++] & 0xFF)) << 16)
	...
	return ((source[sourceOffset++] & 0xFF)) | (((source[sourceOffset++] & 0xFF)) << 8) | (((source[sourceOffset++] & 0xFF)) << 16)
		| (((source[sourceOffset++] & 0xFF)) << 24);
    }
	...
	long v = (source[sourceOffset++] & 0xFF) | ((long) (source[sourceOffset++] & 0xFF) << 8) | ((long) (source[sourceOffset++] & 0xFF) << 16)
		| ((long) (source[sourceOffset++] & 0xFF) << 24) | ((long) (source[sourceOffset++] & 0xFF) << 32)
		| ((long) (source[sourceOffset++] & 0xFF) << 40) | ((long) (source[sourceOffset++] & 0xFF) << 48)
	...
	return (source[sourceOffset++] & 0xFF) | ((long) (source[sourceOffset++] & 0xFF) << 8) | ((long) (source[sourceOffset++] & 0xFF) << 16)
		| ((long) (source[sourceOffset++] & 0xFF) << 24) | ((long) (source[sourceOffset++] & 0xFF) << 32)
		| ((long) (source[sourceOffset++] & 0xFF) << 40) | ((long) (source[sourceOffset++] & 0xFF) << 48)
		| ((long) (source[sourceOffset++] & 0xFF) << 56);
    }
